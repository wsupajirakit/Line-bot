...
//
    ...
    //สิ้นสุดแก้ไขผล
        ...
        $uri = "http://redfoxdev.com/backend2/webservice.php?operation=query&sessionName=70abafee5a74367f7bd78&query=select%20*%20from%20Bmember%20where%20bmember_tks_userid='".$userID."'%20;";
        $response = \Httpful\Request::get($uri)->send();
        // echo $response;
