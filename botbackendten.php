...
$access_token =
'ila5R3ynif4KKHw8edAdJkFwcEVVqouC0/BCNT9AwU7kbIn6xYr588PyTzcLzy+u/nMHGx1Ejz0/ggPx2O4+ul+0uQO3FeQkx1ufBJmMBtjtKZL7zcoaXnA2NXkuT6CBzUAI67PNsKMg3nes/fTsmQdB04t89/1O/w1cDnyilFU=';

$sidname='7a42c3d05a82a33acf7e1';
$vturl='http://redfoxdev.com/backend10/';
            ...
            if ($ix != 1 && $tx!=1) {
                  ...
                  if($money <= 200 && $money >=20) {
                              ...
                              curl_setopt_array($curl, array(
                                CURLOPT_URL => "http://redfoxdev.com/backend10/webservice.php",
...
//
    ...
    //สิ้นสุดแก้ไขผล
        ...
        if(strcmp($teststr,"id") == 0){
          ...
          $uriu = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bcenter%20Where%20id%20='39x28';";
...
🏧ช่องทางการฝากเงิน 24 ชั่วโมง
      กสิกรไทย 0372523913
      พร้อมเพย์ 0644731049      🆓ค่าธรรมเนียม
🚩ถอนเงินแจ้งแอดมิน แปะ พพ. ไว้หลังปิด live โอนให้ทุกคน
  '
                      ...
                      $datax = [
                        'to' => 'C23a8c2a40e2c284f421fcd152425c4a5',
                        'messages' => [$messagesx],
                      ];
