...
$access_token =
'bRd7sGRmWtGGoUK/4QK+1jvftp3UUsxsm3h9tpZMXF3Kz7aP2B1yffpbzKlKGe9kVozo/98eAK5bbEYtmlGOOB1fGiWqLif9T7OzPbAxPMPlH5fT4RuPcKvO7JT8iwDCO0aHQzKg6qOQQ4Zv6bMWLAdB04t89/1O/w1cDnyilFU=';

$sidname='2b0573625a7565d479a0d';
      ...
      if(strlen($usernamex)>0){
            if ($ix != 1 && $tx!=1) {
                              ...
                              if ($err) {
                                ...
                                if($lenchoice >=2)
                                {
                                  ...
                                  curl_setopt_array($curl, array(
                                    ...
                                    CURLOPT_HTTPHEADER => array(
                                      "authorization: Bearer bRd7sGRmWtGGoUK/4QK+1jvftp3UUsxsm3h9tpZMXF3Kz7aP2B1yffpbzKlKGe9kVozo/98eAK5bbEYtmlGOOB1fGiWqLif9T7OzPbAxPMPlH5fT4RuPcKvO7JT8iwDCO0aHQzKg6qOQQ4Zv6bMWLAdB04t89/1O/w1cDnyilFU=",
                                      "cache-control: no-cache",
                  ...
                  $messages = [
                    'type' => 'text',
                    // 'text' => 'แทงผู้เล่น'.$player.'จำนวน'.$money.'ชื่อผู้เล่น'.$username.'ยอดคงเหลือ'.$balance.'vid:'.$vid
                    'text' => 'รูปแบบการแทงไม่ถูกต้อง แทงได้แค่ T1 - T4 เท่านั้น ต่ำสุด 20 สูงสุด 500  ตัวอย่าง : T1234-50 หรือ T1-200'
                  ];
...
// **************
              ...
              foreach($data["result"] as $item) { //foreach element in $arr
                ...
                curl_setopt_array($curl, array(
                  ...
                  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                  CURLOPT_CUSTOMREQUEST => "POST",
                  CURLOPT_POSTFIELDS => "------WebKitFormBoundary7MA4YWxkTrZu0gW\rd\nContent-Disposition: form-data; name=\"operation\"\r\n\r\nupdate\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"sessionName\"\r\n\r\n2b0573625a7565d479a0d\r\n------WebKitFormBoundary7MA4YWxkTrZu0gW\r\nContent-Disposition: form-data; name=\"element\"\r\n\r\n        {\n            \"bmemberno\": \"\",\n
...
//
    ...
    //สิ้นสุดแก้ไขผล
        ...
        if(strcmp($teststr,"id") == 0){
          ...
          $uriu = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bcenter%20Where%20id%20='39x8';";
  ...
  พิมพ์ T ตามด้วยขาที่จะเล่น แล้ว ขีด (-) จำนวนเงิน เช่น T12-500 คือ แทงขา 1 และขา 2 ขาละ 500 บาท
  ⬇️
  จำนวนเงินในการแทง 20-500 บาทต่อ 1 ขา เล่นเผื่อซ่อมเด้งด้วย
  ⬇️
