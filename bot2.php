...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
      ...
      $lentext = strlen($newtext);
        ...
        //gamestatus
        $uri = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='41x328';";
          ...
          $adminID = $response->body->result[0]->bgame_tks_adminid;
            ...
            if(strcmp($adminID,$userID) == 0){
              ...
              foreach($datax["result"] as $itemx) {
                  ...
                  $urit = $vturl."webservice.php?operation=query&sessionName=".$sidname."&query=select%20*%20from%20Bgame%20Where%20id%20='41x328';";
